...
export default function Topbar(){
  return (
    <div className="topbar">
      <div className="container mx-auto px-6 py-3 flex flex-col md:flex-row gap-3 md:gap-8 items-center justify-between">
        <div className="flex flex-wrap gap-6 text-gray-400 text-xs">
          ...
          <a 
            className="hover:text-[var(--brand-yellow)] transition-colors flex items-center gap-2" 
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <svg className="w-4 h-4 instagram-icon" viewBox="0 0 24 24" fill="currentColor">
